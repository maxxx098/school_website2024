     ...
     <section className="hero_section">
        ...
        <div className="hero_box">
           <p className='hero_box_paragraph' data-aos="fade-zoomIn">HOME / PAGE / <span>CLASSES</span></p>
            <h1 className='hero_header-1'data-aos="fade-zoomIn">General English Classes
            </h1>
        ...
        <div className="hero_box_button">
           ...
           <button className='button-1'data-aos="fade-right"><a href="#classes_2">GET STARTED</a></button>
